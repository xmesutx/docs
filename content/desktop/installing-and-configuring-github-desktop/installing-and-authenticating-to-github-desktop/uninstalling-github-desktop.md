...
1. In a Finder window, navigate to the Applications folder.
  ![Applications folder in the Finder window](/assets/images/2021/10/help/desktop/applications-folder.png)
2. While pressing the **Control** button on your keyboard, click **{% data variables.product.prodname_desktop %}**.
3. Choose **Move to Trash**.
  ![The Move to Trash option](/assets/images/2021/10/help/desktop/mac-move-to-trash.png)
4. In the menu bar, use the **Finder** drop-down menu, then click **Empty Trash**.
  ![The Empty Trash option in the menu bar](/assets/images/2021/10/help/desktop/mac-empty-trash-menu.png)
5. Read the warning in the pop-up box and click **Empty Trash**.
  ![The Empty Trash button](/assets/images/2021/10/help/desktop/mac-empty-trash-button.png)
...
2. Under "Programs", click **Uninstall a program**.
  ![The Uninstall a Program option in Control Panel](/assets/images/2021/10/help/desktop/windows-uninstall-a-program.png)
3. Right-click the entry named **{% data variables.product.prodname_desktop %}**, then click **Uninstall**.
  ![The Uninstall option](/assets/images/2021/10/help/desktop/windows-click-uninstall.png)
