...
{% data reusables.desktop.choose-a-theme %}
  ![The theme options on the Appearance tab for Mac](/assets/images/2021/10/help/desktop/mac-appearance-tab-themes.png)
...
{% data reusables.desktop.choose-a-theme %}
  ![The theme options on the Appearance tab for Windows](/assets/images/2021/10/help/desktop/windows-appearance-tab-themes.png)
