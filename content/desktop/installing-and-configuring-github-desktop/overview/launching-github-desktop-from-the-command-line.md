...
![Install Command Line Tool option in the {% data variables.product.prodname_desktop %} drop-down menu](/assets/images/2021/10/help/desktop/mac-install-command-line-tool.png)
2. Open Terminal.
