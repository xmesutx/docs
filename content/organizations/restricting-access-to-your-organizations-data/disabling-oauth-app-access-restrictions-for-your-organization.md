...
5. Click **Remove restrictions**.
  ![Remove restrictions button](/assets/images/2021/10/help/settings/settings-third-party-remove-restrictions.png)
6. After you review the information about disabling third-party application restrictions, click **Yes, remove application restrictions**.
  ![Remove confirmation button](/assets/images/2021/10/help/settings/settings-third-party-confirm-disable.png)
