...
1. Decide whether to disable organization-wide project boards, disable repository project boards in the organization, or both. Then, under "Projects":
  ...
  ![Checkboxes to disable projects for an organization or for all of an organization's repositories](/assets/images/2021/10/help/projects/disable-org-projects-checkbox.png)
1. Click **Save**.
