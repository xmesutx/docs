...
4. Click either **Members** or **Outside collaborators** to manage people with different types of access. ![Button to invite members or outside collaborators to an organization](/assets/images/2021/10/help/organizations/select-outside-collaborators.png)
...
![Manage access button for a repository](/assets/images/2021/10/help/organizations/repository-manage-access.png)
...
![Repository access matrix for the user](/assets/images/2021/10/help/organizations/repository-access-matrix-for-user.png)
{% endif %}
## Further reading
