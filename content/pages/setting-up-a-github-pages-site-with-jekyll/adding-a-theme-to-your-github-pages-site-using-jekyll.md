...
4. Add a new line to the file for the theme name.
   ...
   ![Supported theme in config file](/assets/images/2021/10/help/pages/add-theme-to-config-file.png)
   ...
   ![Unsupported theme in config file](/assets/images/2021/10/help/pages/add-remote-theme-to-config-file.png)
