...
4. At the top of the wiki, click the revision link.
   ![Wiki revision link](/assets/images/2021/10/help/wiki/wiki_revision_link.png)
...
![Wiki SHA number](/assets/images/2021/10/help/wiki/wiki_sha_number.png)

## Comparing two revisions

1. Select two rows that you want to compare.
2. At the top of the history table, click **Compare Revisions**.
   ![Wiki compare revisions button](/assets/images/2021/10/help/wiki/wiki_compare_revisions.png)
...
3. You'll see a diff of the changes showing which lines were added, removed, and modified.
   ![Wiki revision diff](/assets/images/2021/10/help/wiki/wiki_revision_diff.png)
4. To revert the newer changes, click **Revert Changes**.
   ![Wiki revert changes button](/assets/images/2021/10/help/wiki/wiki_revert_changes.png)
