...
![Minimized comment](/assets/images/2021/10/help/repository/hidden-comment.png)
...
2. In the upper-right corner of the comment, click {% octicon "kebab-horizontal" aria-label="The horizontal kebab icon" %}, then click **Hide**.
  ![The horizontal kebab icon and comment moderation menu showing the edit, hide, delete options](/assets/images/2021/10/help/repository/comment-menu.png)
3. Using the "Choose a reason" drop-down menu, click a reason to hide the comment. Then click, **Hide comment**.
  {% ifversion fpt or ghec %}
  ![Choose reason for hiding comment drop-down menu](/assets/images/2021/10/help/repository/choose-reason-for-hiding-comment.png)
  {% else %}
  ![Choose reason for hiding comment drop-down menu](/assets/images/2021/10/help/repository/choose-reason-for-hiding-comment-ghe.png)
  {% endif %}
...
2. In the upper-right corner of the comment, click **{% octicon "fold" aria-label="The fold icon" %} Show comment**.
   ![Show comment text](/assets/images/2021/10/help/repository/hidden-comment-show.png)
3. On the right side of the expanded comment, click {% octicon "kebab-horizontal" aria-label="The horizontal kebab icon" %}, then **Unhide**.
   ![The horizontal kebab icon and comment moderation menu showing the edit, unhide, delete options](/assets/images/2021/10/help/repository/comment-menu-hidden.png)
...
![Comment with added note that content was redacted](/assets/images/2021/10/help/repository/content-redacted-comment.png)
...
2. In the upper-right corner of the comment, click {% octicon "kebab-horizontal" aria-label="The horizontal kebab icon" %}, then click **Edit**.
  ![The horizontal kebab icon and comment moderation menu showing the edit, hide, delete, and report options](/assets/images/2021/10/help/repository/comment-menu.png)
3. In the comment window, delete the content you'd like to remove, then type `[REDACTED]` to replace it.
  ![Comment window with redacted content](/assets/images/2021/10/help/issues/redacted-content-comment.png)
4. At the bottom of the comment, type a note indicating that you have edited the comment, and optionally, why you edited the comment.
  ![Comment window with added note that content was redacted](/assets/images/2021/10/help/issues/note-content-redacted-comment.png)
...
![Anonymized timeline event for a deleted comment](/assets/images/2021/10/help/issues/anonymized-timeline-entry-for-deleted-comment.png)
