...
3. In the file name field:
  ...
  ![New pull request template name in root directory](/assets/images/2021/10/help/repository/pr-template-file-name.png)
  ...
  ![New pull request template in docs directory](/assets/images/2021/10/help/repository/pr-template-file-name-docs.png)
    - To store your file in a hidden directory, name the pull request template `.github/pull_request_template.md`.
  ![New pull request template in hidden directory](/assets/images/2021/10/help/repository/pr-template-hidden-directory.png)
  ...
  ![New multiple pull request template in hidden directory](/assets/images/2021/10/help/repository/pr-template-multiple-hidden-directory.png)
