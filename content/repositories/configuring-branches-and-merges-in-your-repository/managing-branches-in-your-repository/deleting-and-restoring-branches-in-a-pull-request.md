...
5. Near the bottom of the pull request, click **Delete branch**.
   ![Delete branch button](/assets/images/2021/10/help/pull_requests/delete_branch_button.png)
...
5. Near the bottom of the pull request, click **Restore branch**.
   ![Restore deleted branch button](/assets/images/2021/10/help/branches/branches-restore-deleted.png)
