...
3. Under "Danger Zone", to the right of to "Change repository visibility", click **Change visibility**.
   ![Change visibility button](/assets/images/2021/10/help/repository/repo-change-vis.png)
4. Select a visibility.
{% ifversion fpt or ghec %}
   ![Dialog of options for repository visibility](/assets/images/2021/10/help/repository/repo-change-select.png){% else %}
...
{% ifversion fpt or ghec %}
   ![Confirm change of repository visibility button](/assets/images/2021/10/help/repository/repo-change-confirm.png){% else %}
