...
![Button to create a new GitHub App](/assets/images/2021/10/github-apps/github_apps_new.png)
1. In "GitHub App name", type the name of your app.
![Field for the name of your GitHub App](/assets/images/2021/10/github-apps/github_apps_app_name.png)
...
![Field for a description of your GitHub App](/assets/images/2021/10/github-apps/github_apps_description.png)
1. In "Homepage URL", type the full URL to your app's website.
![Field for the homepage URL of your GitHub App](/assets/images/2021/10/github-apps/github_apps_homepage_url.png)
...
1. In "Callback URL", type the full URL to redirect to after a user authorizes the installation. This URL is used if your app needs to identify and authorize user-to-server requests.
  ...
  ![Button for 'Add callback URL' and field for callback URL](/assets/images/2021/10/github-apps/github_apps_callback_url_multiple.png)
{% else %}
...
![Field for the user authorization callback URL of your GitHub App](/assets/images/2021/10/github-apps/github_apps_user_authorization.png)
...
![Request user authorization during installation](/assets/images/2021/10/github-apps/github_apps_request_auth_upon_install.png)
1. If additional setup is required after installation, add a "Setup URL" to redirect users to after they install your app.
![Field for the setup URL of your GitHub App ](/assets/images/2021/10/github-apps/github_apps_setup_url.png)
...
![Field for the webhook URL of your GitHub App](/assets/images/2021/10/github-apps/github_apps_webhook_url.png)

1. Optionally, in "Webhook Secret", type an optional secret token used to secure your webhooks.
![Field to add a secret token for your webhook](/assets/images/2021/10/github-apps/github_apps_webhook_secret.png)
...
![Various permissions for your GitHub App](/assets/images/2021/10/github-apps/github_apps_new_permissions_post2dot13.png)
...
![Installation options for your GitHub App](/assets/images/2021/10/github-apps/github_apps_installation_options.png)
1. Click **Create GitHub App**.
![Button to create your GitHub App](/assets/images/2021/10/github-apps/github_apps_create_github_app.png)
