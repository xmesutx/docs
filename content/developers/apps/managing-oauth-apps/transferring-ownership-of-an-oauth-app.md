...
![Button to transfer ownership](/assets/images/2021/10/oauth-apps/oauth_apps_transfer_ownership.png)
6. Type the name of the {% data variables.product.prodname_oauth_app %} you want to transfer.
![Field to enter the name of the app to transfer](/assets/images/2021/10/oauth-apps/oauth_apps_transfer_oauth_name.png)
7. Type the name of the user or organization you want to transfer the {% data variables.product.prodname_oauth_app %} to.
![Field to enter the user or org to transfer to](/assets/images/2021/10/oauth-apps/oauth_apps_transfer_new_owner.png)
8. Click **Transfer this application**.
![Button to transfer the application](/assets/images/2021/10/oauth-apps/oauth_apps_transfer_application.png)
