...
![Permissions and webhooks](/assets/images/2021/10/github-apps/github_apps_permissions_and_webhooks.png)
...
![Permissions selections for your GitHub App](/assets/images/2021/10/github-apps/github_apps_permissions_post2dot13.png)
7. In "Subscribe to events", select any events to which you'd like to subscribe your app.
![Permissions selections for subscribing your GitHub App to events](/assets/images/2021/10/github-apps/github_apps_permissions_subscribe_to_events.png)
...
![Input box to add a note to users explaining why your GitHub App permissions have changed](/assets/images/2021/10/github-apps/github_apps_permissions_note_to_users.png)
9. Click **Save changes**.
![Button to save permissions changes](/assets/images/2021/10/github-apps/github_apps_save_changes.png)
