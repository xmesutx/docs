...
![Screenshot of the button to test SAML configuration before enforcing](/assets/images/2021/10/help/enterprises/saml-recovery-codes-link.png)

2. To save your recovery codes, click **Download**, **Print**, or **Copy**.
![Screenshot of the buttons to download, print, or copy your recovery codes](/assets/images/2021/10/help/saml/saml_recovery_code_options.png)
