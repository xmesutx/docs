...
3. Choose to configure the `IPv4` or `IPv6` protocol.
  ![Options to choose the IPv4 or the IPv6 protocol](/assets/images/2021/10/enterprise/network-configuration/IPv4-or-IPv6-protocol.png)
4. Configure options for the protocol you chose.
  ![Menu with IP protocol options](/assets/images/2021/10/enterprise/network-configuration/network-settings-selection.png)
