...
3. In the left sidebar, click **Teams**.
  ![Teams tab in the enterprise sidebar](/assets/images/2021/10/help/business-accounts/settings-teams-tab.png)
...
5. Under "Team discussions", use the drop-down menu and choose a policy.
  ![Drop-down menu with team discussion policy options](/assets/images/2021/10/help/business-accounts/team-discussion-policy-drop-down.png)
