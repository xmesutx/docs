...
![Add pre-receive hook](/assets/images/2021/10/enterprise/site-admin-settings/add-pre-receive-hook.png)
5. In the **Hook name** field, enter the name of the hook that you want to create.
![Name pre-receive hook](/assets/images/2021/10/enterprise/site-admin-settings/hook-name.png)
6. From the **Environment** drop-down menu, select the environment on which you want the hook to run.
![Hook environment](/assets/images/2021/10/enterprise/site-admin-settings/environment.png)
...
![Hook script](/assets/images/2021/10/enterprise/site-admin-settings/hook-script.png)
...
![Use exit-status](/assets/images/2021/10/enterprise/site-admin-settings/use-exit-status.png)
...
![Enable hook all repositories](/assets/images/2021/10/enterprise/site-admin-settings/enable-hook-all-repos.png)
...
![Admins enable or disable hook](/assets/images/2021/10/enterprise/site-admin-settings/admins-enable-hook.png)
...
![Edit pre-receive](/assets/images/2021/10/enterprise/site-admin-settings/edit-pre-receive-hook.png)
...
![Edit pre-receive](/assets/images/2021/10/enterprise/site-admin-settings/delete-pre-receive-hook.png)
...
![Hooks sidebar](/assets/images/2021/10/enterprise/orgs-and-teams/hooks-sidebar.png)
...
![Hook permissions](/assets/images/2021/10/enterprise/orgs-and-teams/hook-permissions.png)
...
![Repositories](/assets/images/2021/10/enterprise/repos/repositories.png)
{% data reusables.repositories.sidebar-settings %}
4. In the left sidebar, click **Hooks & Services**.
![Hooks and services](/assets/images/2021/10/enterprise/repos/hooks-services.png)
...
![Repository hook permissions](/assets/images/2021/10/enterprise/repos/repo-hook-permissions.png)
