...
![Checkbox to enable or disable {% data variables.product.prodname_code_scanning %}](/assets/images/2021/10/enterprise/management-console/enable-code-scanning-checkbox.png){% endif %}
