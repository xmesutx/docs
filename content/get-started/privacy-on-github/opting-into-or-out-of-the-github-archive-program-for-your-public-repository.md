...
3. Under "Features", select or unselect **Preserve this repository**.
    ![Checkbox for allowing {% data variables.product.prodname_dotcom %} to include your code in the {% data variables.product.prodname_archive %}](/assets/images/2021/10/help/repository/github-archive-program-checkbox.png)
