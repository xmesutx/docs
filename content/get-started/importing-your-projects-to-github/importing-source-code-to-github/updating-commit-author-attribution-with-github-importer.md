...
![Match authors button](/assets/images/2021/10/help/importer/match-authors-button.png)
2. Next to the author whose information you'd like to update, click **Connect**.
![List of commit authors](/assets/images/2021/10/help/importer/connect-commit-author.png)
