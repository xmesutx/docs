...
![Starring a repository](/assets/images/2021/10/help/stars/starring-a-repository.png)
1. Optionally, to unstar a previously starred repository, click **Unstar**.
![Untarring a repository](/assets/images/2021/10/help/stars/unstarring-a-repository.png)
...
2. Next to "Lists", click **Create list**.
  ![Screenshot of "Create list" button](/assets/images/2021/12/help/stars/create-list.png)
3. Enter a name and description for your list and click **Create**.
  ![Screenshot of modal showing where you enter a name and description with the "Create" button.](/assets/images/2021/12/help/stars/create-list-with-description.png)

### Adding a repository to a list

{% data reusables.stars.stars-page-navigation %}
2. Find the repository you want to add to your list.
  ![Screenshot of starred repos search bar](/assets/images/2021/12/help/stars/search-bar-for-starred-repos.png)
3. Next to the repository you want to add, use the **Starred** dropdown menu and select your list.
  ![Screenshot of dropdown showing a list checkboxes](/assets/images/2021/12/help/stars/add-repo-to-list.png)
...
3. Next to the repository you want to remove, use the **Starred** dropdown menu and deselect your list.
  ![Screenshot of dropdown showing list checkboxes](/assets/images/2021/12/help/stars/add-repo-to-list.png)
...
3. Update the name or description and click **Save list**.
  ![Screenshot of modal showing "Save list" button](/assets/images/2021/12/help/stars/edit-list-options.png) 
...
3. Click **Delete list**.
  ![Screenshot of modal showing "Delete list" button](/assets/images/2021/12/help/stars/edit-list-options.png)
...
![Searching through stars](/assets/images/2021/10/help/stars/stars_search_bar.png)
...
![Sorting stars](/assets/images/2021/10/help/stars/stars_sort_menu.png)
1. To filter your list of stars based on their language, click on the desired language under **Filter by languages**.
![Filter stars by language](/assets/images/2021/10/help/stars/stars_filter_language.png)
1. To filter your list of stars based on repository or topic, click on the desired option.
![Filter stars by topic](/assets/images/2021/10/help/stars/stars_filter_topic.png)
