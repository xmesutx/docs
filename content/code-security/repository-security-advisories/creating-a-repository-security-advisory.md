...
4. Click **New draft security advisory**.
  ![Open draft advisory button](/assets/images/2021/10/help/security/security-advisory-new-draft-security-advisory-button.png)
...
11. Click **Create draft security advisory**.
  ![Create security advisory button](/assets/images/2021/10/help/security/security-advisory-create-security-advisory-button.png)
