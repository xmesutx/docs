...
3. In the left sidebar, click **Security policy**.
  ![Security policy tab](/assets/images/2021/10/help/security/security-policy-tab.png)
4. Click **Start setup**.
  ![Start setup button](/assets/images/2021/10/help/security/start-setup-security-policy-button.png)
