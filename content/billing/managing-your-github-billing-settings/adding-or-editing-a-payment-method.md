...
![Billing New Card button](/assets/images/2021/10/help/billing/billing-information-edit-button.png)
{% data reusables.dotcom_billing.enter-billing-info %}
1. If your account has an existing payment method that you want to update, click **Edit**.
![Billing New Card button](/assets/images/2021/10/help/billing/billing-payment-method-edit-button.png)
