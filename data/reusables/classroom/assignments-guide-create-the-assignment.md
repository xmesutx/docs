...
1. In the {% octicon "repo" aria-label="The repo icon" %} **Assignments** tab, create the assignment.
   ...
   ![Creating your first assignment](/assets/images/2021/10/help/classroom/assignments-create-first-assignment.png)
   - Otherwise, click **New assignment**.
   ![The 'New assignment' button](/assets/images/2021/10/help/classroom/assignments-click-new-assignment-button.png)
