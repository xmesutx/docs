1. Enter the details for your new custom pattern:
   ...
   ![Create a custom {% data variables.product.prodname_secret_scanning %} pattern form](/assets/images/2021/10/help/repository/secret-scanning-create-custom-pattern.png)
   {% else %}
   ![Create a custom {% data variables.product.prodname_secret_scanning %} pattern form](/assets/images/2022/02/enterprise/3.2/repository/secret-scanning-create-custom-pattern.png)
   {% endif %}
