...
![The branch in the status bar](/assets/images/2021/10/help/codespaces/branch-in-status-bar.png)
...
![Choose from the branch menu](/assets/images/2021/10/help/codespaces/create-new-branch.png)
