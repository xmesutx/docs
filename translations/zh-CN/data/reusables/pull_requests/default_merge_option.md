在 {% data variables.product.product_location %} 上的拉请求上中单击默认的 **Merge pull request（合并拉请求）**选项时，来自功能分支的所有提交都会在合并提交中添加到基础分支。 拉取请求使用 [`--no-ff` 选项](https://git-scm.com/docs/git-merge#_fast_forward_merge)合并。
