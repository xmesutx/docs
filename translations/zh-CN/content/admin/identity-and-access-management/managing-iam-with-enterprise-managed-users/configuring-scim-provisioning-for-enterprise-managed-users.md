...
1. 单击 **Generate token（生成令牌）**。 ![生成令牌按钮](/assets/images/2021/10/help/settings/generate_token.png)
1. To copy the token to your clipboard, click the {% octicon "paste" aria-label="The copy icon" %}. ![新建的令牌](/assets/images/2021/10/help/settings/personal_access_tokens.png)
