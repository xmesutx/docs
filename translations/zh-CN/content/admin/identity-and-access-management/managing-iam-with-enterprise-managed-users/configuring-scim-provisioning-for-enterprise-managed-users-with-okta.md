...
1. In the "API Token" field, enter the personal access token with the **admin:enterprise** scope belonging to the setup user. ![Screenshot showing the API Token field on Okta](/assets/images/2021/10/help/enterprises/okta-emu-token.png)
...
1. In the settings menu, click **To App**. ![Screenshot showing the To App menu item on Okta](/assets/images/2021/10/help/enterprises/okta-emu-to-app-menu.png)
1. To the right of "Provisioning to App", to allow changes to be made, click **Edit**.
1. Select **Enable** for **Create Users**, **Update User Attributes**, and **Deactivate Users**. ![Screenshot showing provisioning options on Okta](/assets/images/2021/10/help/enterprises/okta-emu-provisioning-to-app.png)
...
![Screenshot showing the role options for provisioned user on Okta](/assets/images/2021/10/help/enterprises/okta-emu-user-role.png)
