...
1. Click **Push Groups**.
  ...
  ![Push Groups（推送组）选项卡](/assets/images/2021/12/help/saml/okta-ae-push-groups-tab.png)
...
1. 要访问仪表板，请在任意页面的右上角中单击 {% octicon "rocket" aria-label="The rocket ship" %}。 ![用于访问站点管理员设置的火箭图标](/assets/images/2021/10/enterprise/site-admin-settings/access-new-settings.png)
