...
1. In the left sidebar, click **Mobile**.
  !["Mobile" in the left sidebar for the {% data variables.product.prodname_ghe_server %} management console](/assets/images/2021/10/enterprise/management-console/click-mobile.png)
1. Under "GitHub Mobile", select or deselect **Enable GitHub Mobile Apps**.
  ![Checkbox for "Enable GitHub Mobile Apps" in the {% data variables.product.prodname_ghe_server %} management console](/assets/images/2021/10/enterprise/management-console/select-enable-github-mobile-apps.png)
