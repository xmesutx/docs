...
1. 在“Security（安全）”下，单击 **Dependency graph（依赖关系图）**。 ![启用或禁用依赖关系图的复选框](/assets/images/2021/10/enterprise/3.2/management-console/enable-dependency-graph-checkbox.png)
