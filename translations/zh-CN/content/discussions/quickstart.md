...
1. 在仓库名称下，单击 {% octicon "gear" aria-label="The gear icon" %} **Settings（设置）**。 ![公共设置按钮](/assets/images/2021/10/help/discussions/public-repo-settings.png)
1. 在“Features（功能）”下，单击 **Set up discussions（设置讨论）**。 ![在"Features（功能）"下设置讨论按钮，用于对仓库启用或禁用 GitHub Discussions](/assets/images/2021/10/help/discussions/setup-discussions-button.png)
