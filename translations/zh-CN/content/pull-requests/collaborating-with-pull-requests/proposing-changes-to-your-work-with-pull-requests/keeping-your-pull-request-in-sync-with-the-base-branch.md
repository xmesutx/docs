...
{% else %}
1. In the merge section near the bottom of the page, click **Update branch** to perform a traditional merge. ![Button to update branch](/assets/images/2022/02/help/pull_requests/pull-request-update-branch.png)
{% endif %}
