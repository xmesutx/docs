...
![评论中显示的评论者个人资料名称](/assets/images/2021/10/help/issues/commenter-full-name.png)
...
5. 在“Admin repository permissions（管理仓库权限）”下，选中或取消选中 **Allow members to see comment author's profile name in private repositories（允许成员在私有仓库中查看评论作者的个人资料名称）**。 ![允许成员在私有仓库中查看评论作者的全名复选框](/assets/images/2021/10/help/organizations/allow-members-to-view-full-names.png)
6. 单击 **Save（保存）**。
