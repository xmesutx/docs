...
5. 键入新密码，确认新密码，然后单击 **Change password（更改密码）**。 有关创建强密码的帮助，请参阅“[创建强密码](/articles/creating-a-strong-password)”
  ...
  ![密码恢复框](/assets/images/2021/10/enterprise/settings/password-recovery-page.png){% endif %}
