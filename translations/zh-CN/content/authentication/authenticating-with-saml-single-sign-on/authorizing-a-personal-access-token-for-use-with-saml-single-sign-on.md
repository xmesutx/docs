...
4. To the right of the organization you'd like to authorize the token for, click **Authorize**. ![令牌授权按钮](/assets/images/2021/10/help/settings/token-authorize-button.png)
