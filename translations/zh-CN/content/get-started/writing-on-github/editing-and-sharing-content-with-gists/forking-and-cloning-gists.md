...
![Gist 复刻](/assets/images/2021/10/help/gist/gist_forks.png)

## 克隆 Gist

如果要对 Gist 进行本地更改然后将其推送到 web 上，您可以克隆 Gist 然后进行提交，与使用任何 Git 仓库的方法一样。 更多信息请参阅“[克隆仓库](/articles/cloning-a-repository)”。

![Gist 克隆按钮](/assets/images/2021/10/help/gist/gist_clone_btn.png)

## 查看 Gist 提交历史记录

To view a gist's full commit history, click the "Revisions" tab at the top of the gist.

![Gist 版本选项卡](/assets/images/2021/10/help/gist/gist_revisions_tab.png)

您将看到该 Gist 的完整提交历史记录及其差异。

![Gist 版本页面](/assets/images/2021/10/help/gist/gist_history.png)
