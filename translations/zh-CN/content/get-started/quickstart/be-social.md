...
![关注仓库按钮](/assets/images/2021/10/help/repository/repo-actions-watch.png)
...
### 创建拉取请求
 ...
 ![拉取请求按钮](/assets/images/2021/10/help/repository/repo-actions-pullrequest.png)

### 使用议题

在仓库上进行协作时，可使用议题来跟踪想法、增强功能、任务或漏洞。 更多信息请参阅“[关于议题](/articles/about-issues/)”。

![议题按钮](/assets/images/2021/10/help/repository/repo-tabs-issues.png)

### 参与组织

组织是共享帐户，其中业务和开源项目可一次协助处理多个项目。 所有者和管理员可建立具有特殊权限的团队、拥有公共组织资料以及跟踪组织内的活动。 更多信息请参阅“[关于组织](/articles/about-organizations/)”。

![切换帐户上下文下拉列表](/assets/images/2021/10/help/overview/dashboard-contextswitcher.png)
...
您现在已连接到 {% data variables.product.product_name %} 社区。 接下来您要做什么？ ![用星号标记项目](/assets/images/2021/10/help/stars/star-a-project.png)
