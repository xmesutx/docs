...
1. 在左侧边栏中，单击 **Developer settings**。 ![组织设置侧边栏中的开发者设置选项](/assets/images/2021/10/marketplace/developer-settings-in-org-settings.png)
1. 在“Developer settings（开发者设置）”下，单击 **Publisher Verification（发布者验证）**。 ![组织设置侧边栏中的发布者验证选项](/assets/images/2021/10/marketplace/publisher-verification-settings-option.png)
1. 在“Publisher Verification（发布者验证）”下，填写检查列表中的信息：
  ...
  ![发布者验证检查列表](/assets/images/2021/10/marketplace/publisher-verification-checklist.png)
