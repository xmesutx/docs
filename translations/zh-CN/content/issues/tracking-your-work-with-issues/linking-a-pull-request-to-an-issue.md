...
{% else %}
4. 在右侧边栏中，单击 **Linked issues（链接的议题）**。 ![右侧边栏中链接的议题](/assets/images/2021/10/help/pull_requests/linked-issues.png)
{% endif %}
5. 单击要链接到拉取请求的议题。 ![下拉以链接议题](/assets/images/2021/10/help/pull_requests/link-issue-drop-down.png)
{% endif %}
