...
3. 选择是同步项目板的自动化还是重新打开项目板而不同步。
    - 要重新打开项目板并同步自动化，请单击 **Reopen and sync project（重新打开并同步项目）**。 ![选择“重新打开并重新同步项目”按钮](/assets/images/2021/10/help/projects/reopen-and-sync-project.png)
    - 要重新打开项目板而不同步自动化，请使用重新打开下拉菜单，单击 **Reopen only（仅重新打开）**， 然后单击 **Reopen only（仅重新打开）**。 ![重新打开关闭的项目板下拉菜单](/assets/images/2021/10/help/projects/reopen-closed-project-board-drop-down-menu.png)
