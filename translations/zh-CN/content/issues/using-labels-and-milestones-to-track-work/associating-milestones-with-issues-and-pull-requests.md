...
3. 选中要与里程碑关联的项目旁边的复选框。 ![议题元数据复选框](/assets/images/2021/10/help/issues/issues_assign_checkbox.png)
4. 在右上角单击 **Milestone（里程碑）**，然后输入[现有里程碑](/articles/creating-and-editing-milestones-for-issues-and-pull-requests)的名称。 单击里程碑名称以将其与该项目关联。 ![议题里程碑分配下拉菜单](/assets/images/2021/10/help/issues/issues_assigning_milestone_dropdown.png)
