...
![包含自动评分结果的作业概述](/assets/images/2021/10/help/classroom/assignment-individual-hero.png)
...
1. 在左侧边栏中，单击 **Grading and feedback（评分并反馈）**。 ![作业基本知识左侧的"评分并反馈"](/assets/images/2021/10/help/classroom/assignments-click-grading-and-feedback.png)
1. 添加、编辑或删除自动评分测试。
    - 要添加测试，在“Add autograding tests（添加自动评分测试）”下，选择 **Add test（添加测试）**下拉菜单，然后单击您想要使用的评分方法。 ![Using the "Add test" drop-down menu to click a grading method](/assets/images/2021/10/help/classroom/autograding-click-grading-method.png) 配置测试，然后单击“**Save test case（保存测试用例）**”。 ![用于自动评分测试的"保存测试用例"按钮](/assets/images/2021/10/help/classroom/assignments-click-save-test-case-button.png)
    - 要编辑测试，请点击测试名称右侧的 {% octicon "pencil" aria-label="The pencil icon" %}。 ![Pencil icon for editing an autograding test](/assets/images/2021/10/help/classroom/autograding-click-pencil.png) 配置测试，然后单击“**Save test case（保存测试用例）**”。 ![用于自动评分测试的"保存测试用例"按钮](/assets/images/2021/10/help/classroom/assignments-click-save-test-case-button.png)
    - 要删除测试，请点击测试名称右侧的 {% octicon "trash" aria-label="The trash icon" %}。  ![用于删除自动评分测试的垃圾桶图标](/assets/images/2021/10/help/classroom/autograding-click-trash.png)
1. 在页面底部，单击 **Update assignment（更新作业）**。 ![页面底部的"更新作业"按钮](/assets/images/2021/10/help/classroom/assignments-click-update-assignment.png)
...
![选择"下载" 按钮会显示"下载成绩突出显示" 和另一个选项"下载仓库"](/assets/images/2021/10/help/classroom/download-grades.png)

### 查看单个日志
{% data reusables.classroom.sign-into-github-classroom %}
{% data reusables.classroom.click-classroom-in-list %}
{% data reusables.classroom.click-assignment-in-list %}
1. 在提交的右侧，请单击 **View test（查看测试）**。 ![用于作业提交的"查看测试"按钮](/assets/images/2021/10/help/classroom/assignments-click-view-test.png)
