...
2. 右键单击最新的提交并选择 **Amend commit（修订提交）**。 ![修订提交上下文菜单](/assets/images/2021/10/help/desktop/amend-commit-context-menu.png)
...
5. 完成更改后，点击 **Amend last commit（修改上次提交）**。 ![修改上次提交概述](/assets/images/2021/10/help/desktop/amend-last-commit-overview.png)
