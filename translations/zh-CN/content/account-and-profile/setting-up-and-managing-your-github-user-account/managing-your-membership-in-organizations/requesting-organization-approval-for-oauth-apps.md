...
3. 在应用程序列表中，单击您想要请求访问权限的 {% data variables.product.prodname_oauth_app %}的名称。 ![查看应用程序按钮](/assets/images/2021/10/help/settings/settings-third-party-view-app.png)
4. 在您想要 {% data variables.product.prodname_oauth_app %}访问的组织旁边，单击 **Request access（请求访问权限）**。 ![请求访问权限按钮](/assets/images/2021/10/help/settings/settings-third-party-request-access.png)
5. 审查关于请求 {% data variables.product.prodname_oauth_app %}访问权限的信息后，单击 **Request approval from owners（请求所有者的批准）**。 ![请求批准按钮](/assets/images/2021/10/help/settings/oauth-access-request-approval.png)
