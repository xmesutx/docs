...
![个人资料组织框](/assets/images/2021/10/help/profile/profile_orgs_box.png)
...
4. 在成员列表中找到您的用户名。 如果列表很长，可在搜索框中搜索您的用户名。 ![组织成员搜索框](/assets/images/2021/10/help/organizations/member-search-box.png)
5. 在用户名右边的菜单中，选择新的可见性选项：
    - 要公开您的成员关系，请选择 **Public（公共）**。
    - 要隐藏您的成员关系，则选择 **Private（私有）**。 ![组织成员可见性链接](/assets/images/2021/10/help/organizations/member-visibility-link.png)
