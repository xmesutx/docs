...
1. 在页面顶部用户名的右侧，单击 **Switch to another account（切换到另一个帐户）**。 ![上下文切换器按钮](/assets/images/2021/10/help/settings/context-switcher-button.png)
1. 开始键入要切换到的帐户名称，然后单击帐户的名称。 ![上下文切换器菜单](/assets/images/2021/10/help/settings/context-switcher-menu.png)
