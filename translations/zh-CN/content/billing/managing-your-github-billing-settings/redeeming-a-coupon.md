...
4. 在“Redeem your coupon（兑换您的优惠券）”下，单击*个人*帐户用户名旁边的 **Choose（选择）**。 ![选择按钮](/assets/images/2021/10/help/settings/redeem-coupon-choose-button-for-personal-accounts.png)
...
{% data reusables.dotcom_billing.enter_coupon_code_on_redeem_page %}
4. 在“Redeem your coupon（兑换您的优惠券）”下，单击您要将优惠券应用到的*组织*旁边的 **Choose（选择）**。 如果想要将优惠券应用到尚未存在的新组织，请单击 **Create a new organization（创建新组织）**。 ![选择按钮](/assets/images/2021/10/help/settings/redeem-coupon-choose-button.png)
{% data reusables.dotcom_billing.redeem_coupon %}
