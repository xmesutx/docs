...
1. 在“Codespaces secrets（代码空间密码）”的右侧，单击 **New secret（新建密码）**。 !["新建密码"按钮](/assets/images/2021/10/help/settings/codespaces-new-secret-button.png)
1. 在“Name（名称）”下，输入密码的名称。 !["名称"文本框](/assets/images/2021/10/help/settings/codespaces-secret-name-field.png)
...
{% data reusables.user-settings.access_settings %}
{% data reusables.user-settings.codespaces-tab %}
1. 在“Codespaces secrets（代码空间密码）”下您要编辑的密码右侧，单击 **Update（更新）**。 !["更新" 按钮](/assets/images/2021/10/help/settings/codespaces-secret-update-button.png)
1. 在“Value（值）”下，单击 **enter a new value（输入新值）**。 !["输入新值" 链接](/assets/images/2021/10/help/settings/codespaces-secret-update-value-text.png)
{% data reusables.user-settings.codespaces-secret-value %}
{% data reusables.user-settings.codespaces-secret-repository-access %}
1. （可选）要删除密码对仓库的访问权限，请取消选择仓库。 ![删除对仓库访问权限的复选框](/assets/images/2021/10/help/settings/codespaces-secret-repository-checkboxes.png)
...
{% data reusables.user-settings.access_settings %}
{% data reusables.user-settings.codespaces-tab %}
1. 在“Codespaces secrets（代码空间密码）”下您要删除的密码右侧，单击 **Delete（删除）**。 !["删除" 按钮](/assets/images/2021/10/help/settings/codespaces-secret-delete-button.png)
1. 阅读警告，然后单击 **OK（确定）**。 ![确认删除密码](/assets/images/2021/10/help/settings/codespaces-secret-delete-warning.png)
