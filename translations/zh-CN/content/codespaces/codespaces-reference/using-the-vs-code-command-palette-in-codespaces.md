...
- 从应用程序菜单点击 **View > Command Palette…（查看命令调色板…）**。
  ...
  ![应用程序菜单](/assets/images/2021/10/help/codespaces/codespaces-view-menu.png)
...
![与代码空间相关的所有命令列表](/assets/images/2021/10/help/codespaces/codespaces-command-palette.png)
...
![停止代码空间的命令](/assets/images/2021/10/help/codespaces/codespaces-stop.png)
...
![添加开发容器的命令](/assets/images/2021/10/help/codespaces/add-prebuilt-container-command.png)
...
![重建代码空间的命令](/assets/images/2021/10/help/codespaces/codespaces-rebuild.png)
...
![访问日志的命令](/assets/images/2021/10/help/codespaces/codespaces-logs.png)
