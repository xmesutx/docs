...
1. In the **File** menu, click **Add Local Repository**.
  ![Add Local Repository menu option](/assets/images/2021/10/help/desktop/add-local-repository-mac.png)
2. Click **Choose...** and, using the Finder window, navigate to the local repository you want to add.
  ![The Local Path field in the Mac app](/assets/images/2021/10/help/desktop/add-repo-choose-button-mac.png)
4. Click **Add Repository**.
  ![The Add repository button in the Mac app](/assets/images/2021/10/help/desktop/add-repository-button-mac.png)
...
1. In the **File** menu, click **Add local repository**.
  ![Add Local Repository menu option](/assets/images/2021/10/help/desktop/add-local-repository-windows.png)
2. Click **Choose...** and, using Windows Explorer, navigate to the local repository you want to add.
  ![The Local Path field in the Windows app](/assets/images/2021/10/help/desktop/add-repo-choose-button-win.png)
4. Click **Add repository**.
  ![The Add repository button in the Windows app](/assets/images/2021/10/help/desktop/add-repository-button-windows.png)
