...
1. Under "Security," click **Dependency graph**. ![Checkbox to enable or disable the dependency graph](/assets/images/2021/10/enterprise/3.2/management-console/enable-dependency-graph-checkbox.png)
