...
For an architectural overview, see the "[AWS Architecture Diagram for Deploying GitHub Enterprise Server](/assets/images/2021/10/installing-github-enterprise-server-on-aws.png)". 
