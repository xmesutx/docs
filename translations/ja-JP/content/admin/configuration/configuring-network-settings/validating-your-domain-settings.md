...
4. アプライアンスのDNS及びSSLの設定をテストするには、**Test domain settings（ドメイン設定のテスト）**をクリックしてください。 ![[Test domain settings] ボタン](/assets/images/2021/10/enterprise/management-console/test-domain-settings.png)
