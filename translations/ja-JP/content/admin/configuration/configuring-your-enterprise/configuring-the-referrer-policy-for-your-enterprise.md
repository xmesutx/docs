...
1. Under "User Agent Referrer Policy", select **Enable same origin referrer policy for all organizations**. ![Checkbox for enabling same origin referrer policy](/assets/images/2021/10/enterprise/settings/referrer-policy-checkbox.png)
1. [**Save**] をクリックします。 ![Save button for enabling same origin referrer policy](/assets/images/2021/10/enterprise/settings/referrer-policy-save-button.png)
