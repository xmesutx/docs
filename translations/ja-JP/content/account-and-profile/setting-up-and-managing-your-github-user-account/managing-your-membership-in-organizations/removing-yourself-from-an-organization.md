...
3. [Organizations] の下で、自分を削除する Organization を見つけ、[**Leave**] をクリックします。 ![ロールが表示され、その横に [Leave] ボタンがある](/assets/images/2021/10/help/organizations/context-leave-organization-with-roles-shown.png)
