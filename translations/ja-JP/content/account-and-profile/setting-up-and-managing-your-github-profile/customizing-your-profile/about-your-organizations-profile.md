...
![Organization プロフィールページのサンプル](/assets/images/2021/10/help/organizations/org_profile_with_overview.png)
{% else %}
![Organization プロフィールページのサンプル](/assets/images/2021/10/help/profile/org_profile.png)
{% endif %}
