...
3. マイルストーンに関連付けたいアイテムの隣のチェックボックスを選択してください。 ![Issue のメタデータチェックボックス](/assets/images/2021/10/help/issues/issues_assign_checkbox.png)
4. 右上の隅の [**Milestone**] をクリックし、[既存のマイルストーン](/articles/creating-and-editing-milestones-for-issues-and-pull-requests)の名前を入力し始めます。 マイルストーンの名前をクリックして、アイテムに関連付けます。 ![Issue のマイルストーン割り当てドロップダウンメニュー](/assets/images/2021/10/help/issues/issues_assigning_milestone_dropdown.png)
