...
1. 左サイドバーで [**Developer settings**] をクリックします。 ![[organization settings] サイトバーの開発者設定オプション](/assets/images/2021/10/marketplace/developer-settings-in-org-settings.png)
1. [Developer settings] で、[**Publisher Verification**] をクリックします。 ![[organization settings] サイトバーのパブリッシャー検証オプション](/assets/images/2021/10/marketplace/publisher-verification-settings-option.png)
1. [Publisher Verification] のチェックリストに情報を入力してください。
  ...
  ![パブリッシャーの検証チェックリスト](/assets/images/2021/10/marketplace/publisher-verification-checklist.png)
