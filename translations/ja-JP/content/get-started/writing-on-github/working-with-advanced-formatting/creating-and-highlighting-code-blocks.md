...
![表示されたコードブロック](/assets/images/2021/10/help/writing/fenced-code-block-rendered.png)
...
![Ruby の構文を強調して表示されたコードブロック](/assets/images/2021/10/help/writing/code-block-syntax-highlighting-rendered.png)
