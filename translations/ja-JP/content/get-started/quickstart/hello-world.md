...
2. Click the drop down at the top of the file list that says **main**. ![Branch menu](/assets/images/2021/10/help/branch/branch-selection-dropdown.png)
...
1. Click **Merge pull request** to merge the changes into `main`. ![Screen shot of merge button.](/assets/images/2021/10/help/pull_requests/pullrequest-mergebutton.png)
