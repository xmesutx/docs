...
- アプリケーションメニューから、**[View] > [Command Palette…]** をクリックします。
  ...
  ![アプリケーションメニュー](/assets/images/2021/10/help/codespaces/codespaces-view-menu.png)
...
![Codespaces に関連するすべてのコマンドのリスト](/assets/images/2021/10/help/codespaces/codespaces-command-palette.png)
...
![Codespace を停止するコマンド](/assets/images/2021/10/help/codespaces/codespaces-stop.png)
...
![開発コンテナを追加するコマンド](/assets/images/2021/10/help/codespaces/add-prebuilt-container-command.png)
...
![Codespace を再構築するコマンド](/assets/images/2021/10/help/codespaces/codespaces-rebuild.png)
...
![ログにアクセスするコマンド](/assets/images/2021/10/help/codespaces/codespaces-logs.png)
