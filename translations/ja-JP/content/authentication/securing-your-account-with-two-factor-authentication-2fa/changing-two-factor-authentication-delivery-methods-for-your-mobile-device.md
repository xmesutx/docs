...
3. [SMS delivery] の隣にある [**Edit**] をクリックします。 ![SMS 配信オプションの編集](/assets/images/2021/10/help/2fa/edit-sms-delivery-option.png)
4. [Delivery options] の下にある [**Reconfigure two-factor authentication**] をクリックします。 ![2FA 配信オプションの切り替え](/assets/images/2021/10/help/2fa/2fa-switching-methods.png)
