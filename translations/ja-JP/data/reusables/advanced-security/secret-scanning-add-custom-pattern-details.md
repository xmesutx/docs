1. 新しいカスタムパターンの詳細を入力します。
   ...
   ![カスタムの{% data variables.product.prodname_secret_scanning %}パターン形式の作成](/assets/images/2021/10/help/repository/secret-scanning-create-custom-pattern.png)
   {% else %}
   ![カスタムの{% data variables.product.prodname_secret_scanning %}パターン形式の作成](/assets/images/2022/02/enterprise/3.2/repository/secret-scanning-create-custom-pattern.png)
   {% endif %}
