1. "Tracked repositories（追跡されたリポジトリ）"の下で、プルリクエストのリマインダーをTeamに受信させたいリポジトリを選択してください。
  ...
  ![追跡されるリポジトリの選択](/assets/images/2021/10/help/settings/scheduled-reminders-tracked-repos.png)
