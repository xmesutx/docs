1. Insira as informações para o seu novo padrão personalizado:
   ...
   ![Crie um formulário de padrão personalizado de {% data variables.product.prodname_secret_scanning %}](/assets/images/2021/10/help/repository/secret-scanning-create-custom-pattern.png)
   {% else %}
   ![Crie um formulário de padrão personalizado de {% data variables.product.prodname_secret_scanning %}](/assets/images/2022/02/enterprise/3.2/repository/secret-scanning-create-custom-pattern.png)
   {% endif %}
