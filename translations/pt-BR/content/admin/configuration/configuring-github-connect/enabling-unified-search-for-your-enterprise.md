...
1. Em "Usuários podem pesquisarh {% data variables.product.prodname_dotcom_the_website %}", use the menu suspenso e clique em **Habilitado**. ![Habilitar a opção de pesquisa no menu suspenso de pesquisa do GitHub.com](/assets/images/2021/10/enterprise/site-admin-settings/github-dotcom-enable-search.png)
1. Como alternativa, em "Os usuários podem pesquisar repositórios privados em {% data variables.product.prodname_dotcom_the_website %}", use o menu suspenso e clique em **Habilitado**. ![Habilitar a opção de pesquisa em repositórios privados no menu suspenso de pesquisa do GitHub.com](/assets/images/2021/10/enterprise/site-admin-settings/enable-private-search.png)
