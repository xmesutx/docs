...
3. Em {% ifversion fpt or ghec or ghes > 3.4 or ghae-issue-6069 %}"Pull Requests"{% else %}"Botão de merge"{% endif %}, selecione ou desmarque **Excluir branches principais automaticamente**. ![Caixa de seleção para habilitar ou desabilitar a exclusão automática de branches](/assets/images/2021/10/help/repository/automatically-delete-branches.png)
