...
3. Para adicionar uma resposta salva, clique em {% octicon "reply" aria-label="The mail reply" %} no campo de comentários. ![Botão Saved replies (Respostas salvas)](/assets/images/2021/10/help/writing/saved-replies-button.png)
4. Na lista, selecione a resposta salva à qual deseja adicionar seu comentário. ![Respostas salvas](/assets/images/2021/10/help/settings/saved-replies.png)
