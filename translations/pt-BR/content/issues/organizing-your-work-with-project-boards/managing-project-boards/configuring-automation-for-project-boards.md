...
2. Na coluna que deseja automatizar, clique em {% octicon "kebab-horizontal" aria-label="The horizontal kebab icon" %}. ![Ícone Edit (Editar)](/assets/images/2021/10/help/projects/edit-column-button.png)
3. Clique em **Manage automation** (Gerenciar automação). ![Botão Manage automation (Gerenciar automação)](/assets/images/2021/10/help/projects/manage-automation-button.png)
4. Usando o menu suspenso Preset (Predefinida), selecione uma automação predefinida. ![Selecionar automação predefinida no menu](/assets/images/2021/10/help/projects/select-automation.png)
5. Selecione as automações do fluxo de trabalho que deseja configurar para a coluna. ![Lista de opções para automação da coluna](/assets/images/2021/10/help/projects/select-automation-options-existing-column.png)
