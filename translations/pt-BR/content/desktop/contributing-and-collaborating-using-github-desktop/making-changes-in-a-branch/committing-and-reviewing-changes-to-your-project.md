...
![Menu de opções do diff](/assets/images/2021/10/help/desktop/diff-selection.png)
...
![Expandir visualização do diff](/assets/images/2021/10/help/desktop/expand-diff-view.png)
...
* Para acessar as alterações stashed, clique em **Stashed Changes** (Alterações stashed).
  ...
  ![Opção Stashed Changes (Alterações stashed)](/assets/images/2021/10/help/desktop/stashed-changes.png)
* {% data reusables.desktop.commit-all-desc %}

  ![Caixa de seleção para fazer commit em todos os arquivos alterados](/assets/images/2021/10/help/desktop/commit-all.png)
* {% data reusables.desktop.commit-some-desc %}

  ![Caixas de seleção ao lado dos arquivos em que deseja fazer commit](/assets/images/2021/10/help/desktop/commit-some.png)
...
Para excluir linhas alteradas do seu commit, clique em uma ou mais linhas alteradas para que o azul desapareça. As linhas ainda em destaque em azul serão incluídas no commit.
  ...
  ![Linhas desmarcadas em um arquivo](/assets/images/2021/10/help/desktop/partial-commit.png)
...
{% data reusables.desktop.click-discard-files %}
  ...
  ![Opção Discard Changes (Descartar alterações) no menu de contexto](/assets/images/2021/10/help/desktop/discard-changes-mac.png)
{% data reusables.desktop.confirm-discard-files %}

  ![Botão Discard Changes (Descartar alterações) na caixa de diálogo Confirmation (Confirmação)](/assets/images/2021/10/help/desktop/discard-changes-confirm-mac.png)
...
Para descartar uma linha adicionada, na lista de linhas alteradas, clique com o botão direito na linha que você deseja descartar e selecione **Descartar linha adicionada**.
  ...
  ![Descartar uma única linha na caixa de diálogo de confirmação](/assets/images/2021/10/help/desktop/discard-single-line.png)
...
Para descartar um grupo de linhas alteradas, clique com o botão direito na barra vertical à direita dos números de linha para as linhas que você deseja descartar e, em seguida, selecione **Descartar linhas adicionadas**.
  ...
  ![Descartar um grupo de linhas adicionadas na caixa de diálogo de confirmação](/assets/images/2021/10/help/desktop/discard-multiple-lines.png)
...
{% data reusables.desktop.commit-message %}
  ...
  ![Campo Commit message (Mensagem do commit)](/assets/images/2021/10/help/desktop/commit-message.png)
1. Para atribuir um commit a outro autor, você também pode clicar no ícone de adicionar coautores e digitar o nome dos usuários que pretende incluir.
  ...
  ![Adicionar um coautor à mensagem do commit](/assets/images/2021/10/help/desktop/add-co-author-commit.png)
{% data reusables.desktop.commit-button %}

  ![Botão Commit (Fazer commit)](/assets/images/2021/10/help/desktop/commit-button.png)
4. Se o branch com a qual você está tentando fazer commit estiver protegido, o desktop irá avisá-lo.
  ...
  ![Aviso de branch protegido](/assets/images/2021/10/help/desktop/protected-branch-warning.png)
