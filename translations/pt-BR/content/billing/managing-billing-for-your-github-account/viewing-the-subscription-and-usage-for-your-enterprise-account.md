...
1. Em "Licenças de usuário", exiba o total de licenças, o número de licenças consumidas e a data de vencimento da sua assinatura.
  ...
  ![Informações de assinaturas e licenças nas configurações de cobrança da empresa](/assets/images/2021/10/enterprise/enterprise-server/enterprise-server-billing-license-info.png){% endif %}
...
1. Opcionalmente, para visualizar os detalhes de uso para outras funcionalidades, clique em **Cobrança**. ![Aba de faturamento na barra lateral de configurações da conta corporativa](/assets/images/2021/10/help/business-accounts/settings-billing-tab.png)
{% endif %}
