...
5. Em "Exibir informações", arraste e solte uma imagem de uma pasta local ou clique em **Fazer upload de um logotipo** para selecionar uma imagem do seu computador. ![Faça o upload de um logotipo](/assets/images/2021/10/github-apps/github_apps_upload_logo.png)
6. Recorte sua imagem. Ao terminar, clique em **Definir novo avatar**. ![Corte e defina o logotipo ](/assets/images/2021/10/github-apps/github_apps_crop_and_set_avatar.png)
7. Em "Cor de fundo do selo", digite o [código de cor hexadecimal](http://www.color-hex.com/) da cor de fundo para o seu selo. {% ifversion fpt or ghec %}**Observação:** O campo de entrada da "Cor de fundo do selo" só aparecerá depois que você fizer o upload de um logo tipo do aplicativo.{% endif %} ![Cor de fundo do selo](/assets/images/2021/10/github-apps/github_apps_badge_background_color.png)
