...
3. Em "Cancelar publicação do seu perfil do GitHub Sponsors", clique em **Cancelar publicação do perfil**. ![Botão "Remover publicação do perfil"](/assets/images/2021/10/help/sponsors/unpublish-profile-button.png)
4. Para confirmar, clique em "Cancelar publicação da conta do GitHub Sponsors". ![Botão "Cancelar publicação do perfil dos GitHub Sponsors"](/assets/images/2021/10/help/sponsors/unpublish-profile-dialog.png)
