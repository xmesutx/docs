...
- Uma seção "rastreado em" também será exibida na página de alerta correspondente.
  ...
  ![A anotação rastreada na página de alerta de digitalização do código](/assets/images/2021/11/help/repository/code-scanning-alert-tracked-in-pill.png)
...
- No problema de rastreado, {% data variables.product.prodname_dotcom %} exibe um ícone do selo de segurança na lista de tarefas e no hovercard.
  ...
  ![Hovercard no problema rastreado](/assets/images/2021/11/help/repository/code-scanning-tracking-issue-hovercard.png)
...
{% endif %}
1. Na parte superior da página, no lado direito, clique em **Criar problema**. ![Crie um problema de rastreamento para o alerta de digitalização de código](/assets/images/2021/11/help/repository/code-scanning-create-issue-for-alert.png)
...
2. Opcionalmente, edite o título e o texto do problema.
   ...
   ![Novo problema de rastreamento para o alerta de digitalização de código](/assets/images/2021/11/help/repository/code-scanning-new-tracking-issue.png)
