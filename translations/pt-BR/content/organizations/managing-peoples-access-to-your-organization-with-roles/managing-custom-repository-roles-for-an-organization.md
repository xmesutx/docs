...
4. Revise as alterações para a função que você deseja remover e, em seguida, clique em **Excluir função**. ![Confirme a exclusão de uma função do repositório](/assets/images/2021/11/help/organizations/repository-role-delete-confirm.png)
