...
{% data reusables.community.set-interaction-limit %}
  ![Opções Temporary interaction limit (Restrições de interação temporárias)](/assets/images/2021/10/help/settings/user-account-temporary-interaction-limits-options.png)
