1. Ingresa los detalles de tu patrón personalizado nuevo:
   ...
   ![Crear un formato de patrón personalizado del {% data variables.product.prodname_secret_scanning %}](/assets/images/2021/10/help/repository/secret-scanning-create-custom-pattern.png)
   {% else %}
   ![Crear un formato de patrón personalizado del {% data variables.product.prodname_secret_scanning %}](/assets/images/2022/02/enterprise/3.2/repository/secret-scanning-create-custom-pattern.png)
   {% endif %}
