...
![Comentario marcado como respuesta en un debate](/assets/images/2021/10/help/discussions/comment-marked-as-answer.png)
...
1. En la lista de debates, da clic en el debate sin responder que quieras marcar como respondido. ![Debate sin responder](/assets/images/2021/10/help/discussions/unanswered-discussion.png)
1. En el debate, encuentra el comentario que quieras marcar como la respuesta.
1. En la esquina superior derecha del comentario, da clic en {% octicon "check-circle" aria-label="The circular check icon" %}. ![Punto circular de verificación de "Marcar como respuesta" para marcar un comentario en un debate como respuesta](/assets/images/2021/10/help/discussions/comment-mark-as-answer-button.png)
