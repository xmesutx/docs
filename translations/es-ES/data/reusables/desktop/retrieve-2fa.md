1. Si has configurado la autenticación de dos factores para {% data variables.product.prodname_enterprise %}, realiza una de las siguientes acciones:
  ...
  Ingresa entonces tu código de 2FA en el mensaje de {% data variables.product.prodname_desktop %} y da clic en **Iniciar Sesión**. ![El campo de código de autenticación 2FA](/assets/images/2021/10/help/desktop/mac-2fa-code-prompt.png)
