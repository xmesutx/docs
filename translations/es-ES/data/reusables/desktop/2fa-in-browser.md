1. Si has configurado la autenticación de dos factores (2FA) para {% data variables.product.prodname_dotcom %}, realiza una de las siguientes acciones:
  ...
  Ingresa entonces tu código de 2FA en el mensaje de {% data variables.product.prodname_dotcom %} y da clic en **Verificar**. ![El campo de código de autenticación 2FA](/assets/images/2021/10/help/desktop/2fa-code-field.png)
