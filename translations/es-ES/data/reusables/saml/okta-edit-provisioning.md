...
1. A la derecha de "Aprovisionar a la App", da clic en **Editar**.
    ...
    ![Captura de pantalla del botón "Editar" para las opciones de aprovisionamiento de la aplicación de Okta](/assets/images/2021/10/help/saml/okta-provisioning-to-app-edit-button.png)
1. A la derecha de **Crear usuarios**, **Actualizar los atributos de usuario** y **Desactivar usuarios**, selecciona **Habilitar**.

    ![Captura de pantalla de las casillas de verificación de "Habilitar" para las opciones "Crear usuarios", "Actualizar atributos de usuario" y "Desactivar usuarios"](/assets/images/2022/01/help/saml/okta-provisioning-enable-options.png)
