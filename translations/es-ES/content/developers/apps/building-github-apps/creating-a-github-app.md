...
1. Da clic en **GitHub App Nueva**. ![Botón para crear una GitHub App nueva](/assets/images/2021/10/github-apps/github_apps_new.png)
1. E "Nombre dela GitHub App", teclea el nombre de tu app. ![Campo para nombrar tu GitHub App](/assets/images/2021/10/github-apps/github_apps_app_name.png)
...
1. Opcionalmente, en "Descripción", teclea la descripción de tu app que verán los usuarios. ![Campo para agregar una descripción de tu GitHub App](/assets/images/2021/10/github-apps/github_apps_description.png)
1. En "URL de la página principal", teclea la URL completa del sitio web de tu app. ![Campo para la URL de la página de inicio de tu GitHub App](/assets/images/2021/10/github-apps/github_apps_homepage_url.png)
...
1. En "URL del Webhook", teclea la URL a la cual los eventos harán POST. Cada app recibe su propio webhook, el cual te notificará cada que se instale o modifique dicha app, así como sobre cualquier otor evento al cual se suscriba. ![Campo para la URL del webhook de tu GitHub App](/assets/images/2021/10/github-apps/github_apps_webhook_url.png)

1. Opcionalmente, en "Secreto del Webhook", teclea un token secreto opcional que se utilizará para asegurar tus webhooks. ![Campo para agregar un token secreto para tu Webhook](/assets/images/2021/10/github-apps/github_apps_webhook_secret.png)
...
1. En "Permisos", elige aquellos permisos que solicitará tu app. Para cada tipo de permiso, utiliza el menú desplegable, y da clic en **Solo lectura**, **Lectura& escritura**, o **Sin acceso**. ![Varios permisos para tu GitHub App](/assets/images/2021/10/github-apps/github_apps_new_permissions_post2dot13.png)
1. En "Suscribirse a los eventos", elige aquellos que quieras que reciba tu app.
1. Para elegir si la app se podrá instalar, selecciona ya sea **Únicamente en esta cuenta** o **Cualquier cuenta**. Para obtener más información sobre las opciones de instalación, selecciona "[Convertir una GitHub App en pública o privada](/apps/managing-github-apps/making-a-github-app-public-or-private/)". ![Opciones de instalación para tu GitHub App](/assets/images/2021/10/github-apps/github_apps_installation_options.png)
1. Da clic en **Crear GitHub App**. ![Botón para crear tu GitHub App](/assets/images/2021/10/github-apps/github_apps_create_github_app.png)
