...
4. Si no se ha asignado a nadie a la solicitud de cambios o propuesta, haz clic en **asignarte a ti mismo** para asignarte a ti mismo. ![El elemento de asignarte a ti mismo](/assets/images/2021/10/help/issues/assign_yourself.png)
5. En el menú lateral derecho, haz clic en **Asignatarios**. ![El elemento de menú de Asignatarios](/assets/images/2021/10/help/issues/assignee_menu.png)
...
{% data reusables.repositories.navigate-to-repo %}
{% data reusables.repositories.sidebar-issue-pr %}
3. Selecciona la casilla de verificación junto a los elementos que deseas asignar a alguien. ![Casilla de verificación de metadatos de propuestas](/assets/images/2021/10/help/issues/issues_assign_checkbox.png)
