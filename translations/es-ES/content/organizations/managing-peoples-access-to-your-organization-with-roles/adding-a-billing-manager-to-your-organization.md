...
1. Debajo de "Administración de la facturación", junto a "Gerentes de facturación", haz clic en **Agregar**. ![Invitar gerente de facturación](/assets/images/2021/10/help/billing/settings_billing_managers_list.png)
6. Escribe el nombre de usuario o la dirección de correo electrónico de la persona a la que deseas agregar y haz clic en **Send invitation** (Enviar invitación). ![Página Invitar gerente de facturación](/assets/images/2021/10/help/billing/billing_manager_invite.png)
