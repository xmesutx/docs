...
1. En la parte superior de la lágina, a la derecha de tu nombre de usuario, haz clic en **Cambiar a otra cuenta**. ![Botón de interruptor de contexto](/assets/images/2021/10/help/settings/context-switcher-button.png)
1. Comienza a teclear el nombre de la cuenta a la que quieres cambiar y luego haz clic en su nombre. ![Menú del interruptor de contexto](/assets/images/2021/10/help/settings/context-switcher-menu.png)
