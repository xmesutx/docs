...
1. Click **Manage Apps**. ![Add group to app](/assets/images/2021/12/help/saml/okta-ae-group-add-app.png)
...
1. Click **Push Groups**.
  ...
  ![Pestaña de Grupos de Subida](/assets/images/2021/12/help/saml/okta-ae-push-groups-tab.png)
...
6. Under "Identity Provider Group", select the drop-down menu and click an identity provider group. ![Menú desplegable para elegir un grupo de proveedor de identidad](/assets/images/2021/10/enterprise/github-ae/teams/choose-an-idp-group.png)
...
1. Para acceder al tablero, en la esquina superior derecha de cualquier página, haz clic en {% octicon "rocket" aria-label="The rocket ship" %}. ![Icono de cohete para acceder a la configuración de administrador del sitio](/assets/images/2021/10/enterprise/site-admin-settings/access-new-settings.png)

1. In the left pane, click **External groups**.

  ![Agrega un nombre de grupo](/assets/images/2021/12/help/saml/okta-ae-site-admin-external-groups.png)
