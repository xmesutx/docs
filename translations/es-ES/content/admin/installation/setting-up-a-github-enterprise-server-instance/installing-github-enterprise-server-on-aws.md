...
Para ver un resumen arquitectónico, consulta el [Diagrama de Arquitectura de AWS para Desplegar a GitHub Enterprise Server](/assets/images/2021/10/installing-github-enterprise-server-on-aws.png)".
