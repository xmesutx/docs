...
{%- ifversion ghec %}
![Ajustes de perfil empresarial](/assets/images/2021/11/enterprise/custom-footer/enterprise-profile-ghec.png)
{%- else %}
![Ajustes de perfil empresarial](/assets/images/2021/11/enterprise/custom-footer/enterprise-profile-ghes.png)
{%- endif %}

1. At the top of the Profile section, click **Custom footer**. ![Custom footer section](/assets/images/2021/11/enterprise/custom-footer/custom-footer-section.png)

1. Add up to five links in the fields shown. ![Add footer links](/assets/images/2021/11/enterprise/custom-footer/add-footer-links.png)

1. Click **Update custom footer** to save the content and display the custom footer. ![Update custom footer](/assets/images/2021/11/enterprise/custom-footer/update-custom-footer.png)
