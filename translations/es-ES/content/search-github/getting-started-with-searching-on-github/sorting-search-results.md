...
| `sort:author-date-asc`                        | [**`feature org:github sort:author-date-asc`**](https://github.com/search?utf8=%E2%9C%93&q=feature+org%3Agithub+sort%3Aauthor-date-asc&type=Commits) empata las confirmaciones que contengan la palabra "feature" en los repositorios que pertenezcan a {% data variables.product.product_name %}, ordenados por fecha de creación ascendente. |
