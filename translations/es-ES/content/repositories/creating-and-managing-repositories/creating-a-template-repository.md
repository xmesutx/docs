...
1. Selecciona **Repositorio de plantilla**. ![Casilla de verificación para convertir un repositorio en una plantilla](/assets/images/2021/10/help/repository/template-repository-checkbox.png)
