...
4. En la parte superior de la wiki, haz clic en el vínculo de revisión. ![Vínculo de revisión de wiki](/assets/images/2021/10/help/wiki/wiki_revision_link.png)
...
![Número SHA de wiki](/assets/images/2021/10/help/wiki/wiki_sha_number.png)

## Comparar dos revisiones

1. Selecciona dos filas que deseas comparar.
2. En la parte superior de la tabla del historial, haz clic en **Compare Revisions (Comparar revisiones)**. ![Botón de revisiones de comparación de wiki](/assets/images/2021/10/help/wiki/wiki_compare_revisions.png)
...
2. En la parte superior de la tabla del historial, haz clic en **Compare Revisions (Comparar revisiones)**. ![Botón de revisiones de comparación de wiki](/assets/images/2021/10/help/wiki/wiki_compare_revisions.png)
3. Verás una diferencia de los cambios que muestra qué líneas se agregaron, se eliminaron y se modificaron. ![Diferencia de revisión de wiki](/assets/images/2021/10/help/wiki/wiki_revision_diff.png)
4. Para revertir los cambios más recientes, haz clic en **Revert Changes (Revertir cambios)**. ![Botón para revertir cambios de wiki](/assets/images/2021/10/help/wiki/wiki_revert_changes.png)
