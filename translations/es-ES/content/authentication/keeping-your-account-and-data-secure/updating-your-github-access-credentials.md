...
5. Teclea una contraseña nueva, confírmala y haz clic en **Cambiar contraseña**. Para recibir ayuda para crear una contraseña segura, consulta "[Crear una contraseña segura](/articles/creating-a-strong-password)."
  {% ifversion fpt or ghec %}![Password recovery box](/assets/images/2021/10/help/settings/password-recovery-page.png){% else %}
  ![Casilla de recuperación de contraseña](/assets/images/2021/10/enterprise/settings/password-recovery-page.png){% endif %}
