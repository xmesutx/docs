...
3. Para agregar una respuesta guardada, en el campo de comentarios, haz clic en {% octicon "reply" aria-label="The mail reply" %}. ![Botón Saved replies (Respuestas guardadas)](/assets/images/2021/10/help/writing/saved-replies-button.png)
4. Desde la lista, selecciona la respuesta guardada que quieres agregar en el comentario. ![Respuestas guardadas](/assets/images/2021/10/help/settings/saved-replies.png)
