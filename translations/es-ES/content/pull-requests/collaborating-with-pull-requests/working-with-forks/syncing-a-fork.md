...
2. Select the **Fetch upstream** drop-down.
    !["Fetch upstream" drop-down](/assets/images/2021/10/help/repository/fetch-upstream-drop-down.png)
3. Review the details about the commits from the upstream repository, then click **Fetch and merge**.
    !["Fetch and merge" button](/assets/images/2021/10/help/repository/fetch-and-merge-button.png)
