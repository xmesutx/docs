...
2. In the text box below your commit message, add `on-behalf-of: @org <name@organization.com>`.
  ...
  ![Commit message on-behalf-of trailer example in second commit message text box](/assets/images/2021/10/help/repository/write-commit-message-on-behalf-of-trailer.png)
