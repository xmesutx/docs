...
Si no tienes ningún repositorio asociado con {% data variables.product.prodname_desktop %}, tendrás una vista de "Let's get started!", en donde podrás elegir crear y clonar un repositorio de tutorial, clonar un repositorio existente desde internet, crear un repositorio nuevo, o agregar un repositorio existente desde tu disco duro.  ![¡Comencemos! Pantalla](/assets/images/2021/10/help/desktop/lets-get-started.png)
...
1. Haz clic en **Create a tutorial repository and clone it** (Crear un repositorio de tutorial y clonarlo). ![Crear y clonar un botón de repositorio de tutorial](/assets/images/2021/10/help/desktop/getting-started-guide/create-and-clone-a-tutorial-repository.png)
...
1. Haz clic en **Crear un nuevo repositorio en tu disco duro...** ![Crear un repositorio nuevo](/assets/images/2021/10/help/desktop/getting-started-guide/creating-a-repository.png)
2. Llena los campos y selecciona tus opciones preferidas. ![Crear un repositorio de opciones](/assets/images/2021/10/help/desktop/getting-started-guide/create-a-new-repository-options.png)
...
1. Da clic en **Publicar repositorio** en la barra de menú. ![Publicar repositorio](/assets/images/2021/10/help/desktop/getting-started-guide/publish-repository.png)
    ...
    ![Publicar pasos del repositorio](/assets/images/2021/10/help/desktop/getting-started-guide/publish-repository-steps.png)
...
1. Para lanzar tu editor externo desde dentro de {% data variables.product.prodname_desktop %}, da clic en **Repositorio**, luego da clic en **Abrir en <em>EDITOR</em>**. Para obtener más información, consulta la sección "[Configurar un editor predeterminado](/desktop/getting-started-with-github-desktop/configuring-a-default-editor)". ![Abrir en editor](/assets/images/2021/10/help/desktop/getting-started-guide/open-in-editor.png)
...
7. En la ventana, a la derecha de la vista de **Cambios**, verás las sugerencias para las acciones que puedes hacer después. Para abrir el repositorio en {% data variables.product.product_name %} en tu buscador, da clic en **Ver en {% data variables.product.product_name %}**. ![Acciones disponibles](/assets/images/2021/10/help/desktop/available-actions.png)
8. En tu navegador, haz clic en **2 commits** (2 confirmaciones). Verás una lista de las confirmaciones en este repositorio en {% data variables.product.product_name %}. La primera confirmación deberá ser aquella que acabas de realizar en {% data variables.product.prodname_desktop %}. ![Hacer clic en dos confirmaciones](/assets/images/2021/10/help/desktop/getting-started-guide/click-two-commits.png)
